...
def _manifest(version: str) -> dict[str, object]:
    ...
    return {
        ...
        "long_description": (
            ...
            "2. **Every number in a tool result is computed, never generated** — a "
            "deterministic Python core does all arithmetic. Nothing can stop an assistant "
            "typing a figure of its own into chat, so treat any number not traceable to a "
            "tool result as unverified.\n"
